...
const LDRS_CONFERENCE_PROTOTYPES = [
  ...
  '5 שלבי הטמעת AI',
  'איך לידרס עובדים עם AI',
  'מה המוצרים של לידרס בתחום ה-AI',
  'דוגמאות למוצרי AI של לידרס',
  'מה זה NewVoices — סוכן קולי של לידרס',
  'מה זה IMAI — פלטפורמת AI לשיווק משפיענים',
  'Leaders Platform — מוצר פנימי שהפך למוצר ללקוחות',
  'מה זה מחולל הצעות מחיר של לידרס',
  'מצגת קריאייטיבית AI אוטומטית מבריף',
  'בריף לקוח דיגיטלי של לידרס',
  'פגישת התנעה שיתופית',
  'האב מסמכים וניהול לינקים',
  'מה זה בסטי — פלטפורמת AI Agent של לידרס',
  'איך עובד הבוט הזה של לידרס',
  'אוטומציות שלמות מקצה לקצה',
  'מבריף לקוח עד מצגת בלחיצה אחת',
  'תהליך אוטומטי שמחבר בריף, התנעה, הצעה ומצגת',
