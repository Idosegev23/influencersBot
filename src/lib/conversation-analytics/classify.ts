...
כללים:
- **בחר את הכוונה שבשבילה הלקוח פנה — לא את המשפט האחרון בשיחה.** אם שיחה נפתחה
  בבקשת המלצה והסתיימה בשאלת אגב ("אתה איש?", "תודה"), סוג הפנייה הוא בקשת ההמלצה.
  אם עלתה תלונה או בקשה מהותית בכל שלב, היא גוברת על שיחת חולין.
