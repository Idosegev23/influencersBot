...
דוגמאות לconversationTriggers:
- טיפוח: ["שיער יבש", "שיער נושר", "לחות לשיער"]
- אוכל: ["ארוחת שבת", "אוכל מוכן", "מתוק לקינוח"]
- צבע: ["צביעת קיר", "חידוש הסלון", "צבע לחוץ"]
- תבלינים: ["תיבול לבשר", "מתכון מרוקאי", "טעם אותנטי"]`;
