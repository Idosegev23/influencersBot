...
export const support = {
  he: {
    ...
    contactEmailUndeliverable: 'המייל לא נמסר — הדומיין לא קיים',
    contactEmailUseThePhone: 'אפשר לחייג במקום',
    contactCopy: 'העתק',
  ...
  en: {
    ...
    contactEmailUndeliverable: 'Email undeliverable — the domain does not exist',
    contactEmailUseThePhone: 'call instead',
    contactCopy: 'Copy',
