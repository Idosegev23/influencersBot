...
## Intent Types:
- general: שיחה כללית, ברכות, small talk, שאלות על מוצרים/המלצות
- support: כל פנייה שמתארת בעיה / תקלה / נזק / חוסר שביעות רצון.
  כולל:
  • מוצר פגום / שבור / סדוק / מקולקל / "הגיע שבור" / "הגיע פגום"
  • מוצר שגוי / "קיבלתי משהו אחר" / "לא מה שהזמנתי"
  • בעיית משלוח: "לא הגיע", "איחר", "איפה ההזמנה", "לא קיבלתי"
  • בעיה בקופון: "הקוד לא עובד", "קופון לא תקף", "לא מקבלת הנחה"
  • בעיה בתשלום: "חיוב כפול", "חויבתי פעמיים", "לא קיבלתי החזר"
  • איכות: "לא מתאים", "ריח רע", "לא עובד טוב", "התאכזבתי"
  • שאלה לאחר בעיה: "מה אני עושה?", "למי לפנות?", "אני רוצה החזר/החלפה/לבטל"
...
⚠️ חשוב: כל תיאור של מוצר שהגיע במצב לא תקין ("שבור", "פגום", "סדוק", "ניזוק", "לא תקין") = intent="support" — גם אם הניסוח רך או בצורת שאלה.
