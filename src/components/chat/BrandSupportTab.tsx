...
export default function BrandSupportTab({
  ...
  // Strip a leading "#" (some shipping confirmations display as "#1234")
  // + trim whitespace
  ...
  const lookupShipment = useCallback(async () => {
    ...
    try {
      // Send as P1 (shipmentNumber). Per Focus's COO this is the
      // recommended path — using REF (P2) is unreliable due to prefix
      // tagging and can cause cross-customer confusion.
