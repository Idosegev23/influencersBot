...
// Foot Locker account. Username drives the influencer-cookie auth + dashboard route;
...
const ACCOUNT_USERNAME = 'footlocker.il';
...
export default function FootLockerLoginPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled && data) {
          setBrand({
            name: data.brandName || 'FOOT LOCKER',
