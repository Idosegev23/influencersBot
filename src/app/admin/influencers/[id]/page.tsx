    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center gap-5">
        ...
        <div className="flex flex-wrap gap-3 mr-auto">
          ...
          <Link
            href={`/admin/influencers/${id}/analytics`}
            className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#d1d5db]/40 text-sm font-semibold text-[#474747] bg-white hover:border-[#2663EB] hover:text-[#2663EB] transition-all"
          >
