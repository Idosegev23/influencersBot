  ...
  const blocks = [
    {
      ...
      items: [
        ...
        { label: 'חשבון ציבורי', detail: 'אם החשבון Private — ה-API לא יוכל לראות תוכן ולסרוק.' },
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-4 text-sm md:text-base text-stone-600 leading-relaxed">
                בדקנו את זה על שלושה חשבונות שונים, בשני שירותי scraping שונים (ScrapeCreators ו-Apify) —
                שניהם מקבלים מ-Instagram את אותה הודעת חסימה. אין workaround שאינו דורש סשן Instagram מאומת
                (וזה לא משהו שאנחנו עושים).
              </p>
...
function DontNeed() {
  const items = [
    { k: 'סיסמת אינסטגרם', v: 'לא משתמשים ב-auth scraping. רק תוכן ציבורי.' },
...
function Process() {
  const steps = [
    ...
    },
    {
      num: '04',
      title: 'בניית פרסונה',
      desc: 'הרכבת persona ב-GPT-5.4 עם כל ההוראות, הטון, וההגבלות שהוגדרו.',
    },
    {
      num: '05',
