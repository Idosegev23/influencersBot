        ...
        {data && !loading && (
          <>
            ...
            <div className="mt-6 bg-purple-50 border border-purple-100 rounded-xl p-4 text-sm text-purple-900">
              ...
              ברגע שלקוחה מגיעה דרך הלינק או מעתיקה את קוד הקופון של המשפיענית, הסשן/פנייה/העתקה משויכת אוטומטית.
              ההעתקה של קוד קופון היא סיגנל חזק יותר מקליק לינק — והיא <b>נועלת</b> את ההשיוך.
            </div>
          </>
        )}
      </div>
